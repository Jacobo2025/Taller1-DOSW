...
public class MaquinaMisteriosa{
    ...
    public MaquinaMisteriosa(){
        ...
        mensajes.put("BROMEAR",() -> System.out.println("¿Por qué la RAM rompió con la CPU? Porque necesitaba espacio..."));
        mensajes.put("GRITAR", ()-> System.out.println("¡¡¡ALERTA DE STACK OVERFLOW!!!"));
        mensajes.put("SUSURRAR",() -> System.out.println("Shhh... los bugs están dormidos."));
        mensajes.put("ANALIZAR",() -> System.out.println("Analizando datos... resultado: ¡Eres increíble programando!"));
